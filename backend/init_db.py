...
Applies backend/schema.sql to whatever Turso/libSQL instance the
environment points at (TURSO_DATABASE_URL / TURSO_AUTH_TOKEN, or a local
libSQL file when unset — see database.py). Every statement is idempotent
(CREATE TABLE IF NOT EXISTS); nothing is ever dropped, truncated or reset.
